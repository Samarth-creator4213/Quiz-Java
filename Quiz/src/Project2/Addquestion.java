...
public class Addquestion extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            PreparedStatement p=x.prepareStatement("insert into question values(?,?,?,?,?,?,?)");
            p.setString(1,a);
            p.setString(2,b);
            p.setString(3,c);
            p.setString(4,d);
            ...
            if(z>0)
            {
                JOptionPane.showMessageDialog(this,"Added","QUESTION",JOptionPane.INFORMATION_MESSAGE);
                
            }
            else
            {
                JOptionPane.showMessageDialog(this,"Not Added","QUESTION",JOptionPane.INFORMATION_MESSAGE);
