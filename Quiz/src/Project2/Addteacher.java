...
public class Addteacher extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       try
       {
            ...
            PreparedStatement p=x.prepareStatement("insert into teacher values(?,?,?,?)");
            p.setString(1,a);
            p.setString(2,b);
            p.setString(3,c);
            p.setString(4,d);
            ...
            if(z>0)
            {
                JOptionPane.showMessageDialog(this,"MESSAGE","Teacher Added",JOptionPane.INFORMATION_MESSAGE);
                
            }
            else
            {
                JOptionPane.showMessageDialog(this,"MESSAGET","Teacher Not Added",JOptionPane.INFORMATION_MESSAGE);
